/** @file
 * @brief Functions for button support.
 * kmButtons.h
 *
...
#ifndef KM_BUTTONS_H_
#define KM_BUTTONS_H_
...
#define \b KM_BUTTON_DDR  data direction register for button port (e.g DDRC) @n
#define \b KM_BUTTON_PORT_IN button port input (e.g PINC) @n
#define \b KM_BUTTON_PIN button pin (e.g PC1) @n
