...
typedef struct {
	bool enabled;
	kmSwtValueType currentValue;
	kmSwtCallback *_timerCallback;
	void *userData;
} swtItem;

// "Private" global variables.
static swtItem _timers[SWT_SIZE_OF];
static volatile kmSwtValueType _mainInterval = 0;
